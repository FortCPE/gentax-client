...
export default {
  en: {
    ...
    BillStart: 'Bill Start (Amount)',
    StockAmount: 'Stock (Amount)',
    TotalBillPrice: 'Bill Price',
    Business: 'Business',
    InsertBusiness: 'Insert Business',
    ...
    BusinessDashboard: 'Businesses',
    BillDashboard: 'Bills',
    AdminDashboard: 'Admins',
    CalendarDashboard: 'Calendar Events',

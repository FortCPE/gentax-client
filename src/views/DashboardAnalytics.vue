  ...
  <div>
    <div class="vx-row">
      <div class="vx-col md:w-1/4 w-full mb-base">
          <vx-card :title="$t('StockDashboard')" icon="ArchiveIcon">
              <span>4 Units</span>
          </vx-card>
      </div>
      <div class="vx-col md:w-1/4 w-full mb-base">
          <vx-card :title="$t('BusinessDashboard')" icon="BriefcaseIcon">
              <span>4 Units</span>
          </vx-card>
      </div>
      <div class="vx-col md:w-1/4 w-full mb-base">
          <vx-card :title="$t('BillDashboard')" icon="FileTextIcon">
              <span>4 Units</span>
          </vx-card>
      </div>
      <div class="vx-col md:w-1/4 w-full mb-base">
          <vx-card :title="$t('AdminDashboard')" icon="UsersIcon">
              <span>4 Units</span>
          </vx-card>
      </div>
    </div>
    <vx-card :title="$t('CalendarDashboard')" icon="CalendarIcon">

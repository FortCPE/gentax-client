  ...
  routes: [
    ...
    // =============================================================================
      ...
      children: [
        ...
        // =============================================================================
        {
          path: '/apps/bill/insert',
          name: 'bill',
          component: () => import('./views/apps/bill/InsertBill.vue'),
          meta: {
            rule: 'editor',
            no_scroll: true
          }
        ...
        {
          path: '/apps/bill/random',
          name: 'bill',
          component: () => import('./views/apps/bill/RandomBill.vue'),
          meta: {
            rule: 'editor',
            no_scroll: true
          }
        ...
        {
          path: '/apps/business/insert',
          name: 'business',
          component: () => import('./views/apps/business/InsertBusiness.vue'),
          meta: {
            rule: 'editor',
            no_scroll: true
          }
        ...
        {
          path: '/apps/business/manage',
          name: 'business',
          component: () => import('./views/apps/business/ManageBusiness.vue'),
          meta: {
            rule: 'editor',
            no_scroll: true
          }
        ...
        {
          path: '/apps/stock/insert',
          name: 'stock',
          component: () => import('./views/apps/stock/InsertStock.vue'),
          meta: {
            rule: 'editor',
            no_scroll: true
          }
        ...
        {
          path: '/apps/stock/manage',
          name: 'stock',
          component: () => import('./views/apps/stock/ManageStock.vue'),
          meta: {
            rule: 'editor',
            no_scroll: true
          }
        ...
        {
          path: '/apps/stock/delete',
          name: 'stock',
          component: () => import('./views/apps/stock/DeleteStock.vue'),
          meta: {
            rule: 'editor',
            no_scroll: true
          }
        ...
        /*
                ...
                */
        {
          path: '/apps/unit/insert',
          name: 'unit',
          component: () => import('./views/apps/eUnit/insertUnit.vue'),
          meta: {
            rule: 'editor',
            no_scroll: true
          }
        ...
        {
          path: '/apps/unit/manage',
          name: 'unit',
          component: () => import('./views/apps/eUnit/manageUnit.vue'),
          meta: {
            rule: 'editor',
            no_scroll: true
          }
        ...
        {
          path: '/apps/type/insert',
          name: 'type',
          component: () => import('./views/apps/type/insertType.vue'),
          meta: {
            rule: 'editor',
            no_scroll: true
          }
        ...
        {
          path: '/apps/type/manage',
          name: 'type',
          component: () => import('./views/apps/type/manageType.vue'),
          meta: {
            rule: 'editor',
            no_scroll: true
          }

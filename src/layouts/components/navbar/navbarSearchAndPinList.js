...
export default {
  pages: {
    ...
    data: [
      ...
      // APPS
      {title: "Bill",                       url: "/apps/bill/insert",                          icon: "FileTextIcon",       is_bookmarked: true},
      {title: "Business",                   url: "/apps/business/insert",                      icon: "BriefcaseIcon",      is_bookmarked: true},
      {title: "Stock",                      url: "/apps/stock/insert",                         icon: "ArchiveIcon",        is_bookmarked: true},
      {title: "Unit",                       url: "/apps/unit/insert",                          icon: "FileIcon",           is_bookmarked: true},
      {title: "Type",                       url: "/apps/type/insert",                          icon: "InboxIcon",          is_bookmarked: true},
